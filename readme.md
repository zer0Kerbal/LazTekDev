...
[![LazTek Dev (LTD)][SHD:mod]][forum] [![KSP version][KSP:shd]][KSP:url]  [![License][LIC:shd]][LIC:url]  
...
## By [`zer0Kerbal`][zer0Kerbal], inspired by [`LazarusLuan`][lazarusluan]

<img src="https://raw.githubusercontent.com/zer0Kerbal/LazTekDev/master/img/HeroLogo_1920x1920.png" alt="LazTekDev Hero" width="50%" height="50%">

### Preamble by [LazarusLuan][[lazarusluan]

> LazTek Temporal Anomalies is pleased to announce the availability of our LazTek Launch Pack, LazTek Exploration Expansion kit, LazTek Colonial Transporter and LazTek Historical Archive for Kerbal Space Program.
> Available for download in low, medium and high resolution versions, these mods include replicas of the new LazTek Dragon V2 capsule and trunk, LazTek Falcon 9 v1.1 and Falcon Heavy launch platforms, proposed Colonial Transporter, plus special configurations for exploration, asteroid redirection, refueling, colonization and more! Add the LazTek Historic Archive for access to the original DragonRider concept spacecraft.
...
* [LazarusLuan][lazarusluan] for the inspiration to create this mod!
...
<!-- mod links -->
[attrb]: https://zer0kerbal.github.io/LazTekDev/Attributions "Attribution"
[chlog]: https://raw.githubusercontent.com/zer0Kerbal/LazTekDev/master/changelog.md  "Changelog"
[discu]: https://github.com/zer0Kerbal/LazTekDev/discussions "Discussions"
[forum]: https://www.curseforge.com/kerbal/ksp-mods/LazTekDev "LazTek Dev Forum"
[issue]: https://github.com/zer0Kerbal/LazTekDev/issues "Issues"
[notic]: https://zer0kerbal.github.io/LazTekDev/Notices "Notices"
[pages]: https://zer0kerbal.github.io/LazTekDev "GitHub Pages"

<!--- shields -->
[SHD:mod]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/LazTekDev/master/json/mod.json
...
[mm]: https://forum.kerbalspaceprogram.com/index.php?/topic/50533-*/ "Modular Management (MM)"
[m-m]: https://github.com/net-lisias-ksp/ModuleManager "Module Manager /L"
...
Track progress: issues [here][issue] and projects [here](https://github.com/zer0Kerbal/LazTekDev/projects/) along with **[The Short List](https://github.com/users/zer0Kerbal/projects/27)**
