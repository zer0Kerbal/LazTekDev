...
* "LazTek" is trademark of LazarusLuan
* "LazTek Temporal Anomalies" is trademark of LazarusLuan
* "LazTek Dev" is trademark of zer0Kerbal
...
* "LazTek Dev (LTD)" is a fictitious entity created for entertainment purposes. It is in no way meant to represent a real entity. Any similarity to a real entity is purely coincidental.

## LazTek Temporal Anomalies (LTA)

* "LazTek Temporal Anomalies (LTA)" is a fictitious entity created for entertainment purposes. It is in no way meant to represent a real entity. Any similarity to a real entity is purely coincidental.
